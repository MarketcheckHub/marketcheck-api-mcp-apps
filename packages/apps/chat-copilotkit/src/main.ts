/**
 * Dashboard Copilot — CopilotKit Chat Demo
...
const ACCENT = "#8b5cf6";
const SDK_NAME = "CopilotKit";
const SUGGESTIONS = [
  "What are the hottest selling SUVs in Texas right now?",
  "Predict the price for VIN WBA7E2C51JG123456",
  "Search for used BMW 3 Series under $35K near 60601",
  "Show me sold vehicle trends by body type",
...
function init() {
  const { header, content } = createAppShell("Dashboard Copilot");
