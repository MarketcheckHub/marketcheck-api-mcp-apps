# Dashboard Copilot (CopilotKit) ![Chat Demos](https://img.shields.io/badge/Chat%20Demos-6366f1?style=flat-square)

![Screenshot](../../../static/screenshots/chat-copilotkit.png)

## Overview

Demonstrates the CopilotKit pattern — an AI copilot overlay that sits alongside existing dashboard content. The chat interface is a sidebar that can query automotive market data while the main dashboard displays summary metrics.
...
```
https://apps.marketcheck.com/app/chat-copilotkit/?api_key=YOUR_API_KEY
```
...
```html
<iframe src="https://apps.marketcheck.com/app/chat-copilotkit/?api_key=YOUR_API_KEY" width="100%" height="800" frameborder="0"></iframe>
```
...
- [Dashboard Copilot (CopilotKit) App](https://apps.marketcheck.com/app/chat-copilotkit/)
