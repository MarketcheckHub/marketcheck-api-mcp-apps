# Pricing Transparency Report ![Dealer](https://img.shields.io/badge/Dealer-f59e0b?style=flat-square)

![Screenshot](../../../static/screenshots/pricing-transparency-report.png)

## Overview

Generate a professional, shareable pricing report for a specific vehicle. Shows VIN-decoded specs, ML-predicted fair market price, active comparables in the area, and recent sold vehicle data. Designed to be printed or emailed to buyers as evidence of fair pricing.
...
```
https://apps.marketcheck.com/app/pricing-transparency-report/?api_key=YOUR_API_KEY
```
...
```html
<iframe src="https://apps.marketcheck.com/app/pricing-transparency-report/?api_key=YOUR_API_KEY" width="100%" height="800" frameborder="0"></iframe>
```
...
- [Pricing Transparency Report App](https://apps.marketcheck.com/app/pricing-transparency-report/)
