# AI Agent Explorer (LangChain) ![Chat Demos](https://img.shields.io/badge/Chat%20Demos-6366f1?style=flat-square)

![Screenshot](../../../static/screenshots/chat-langchain.png)

## Overview

Demonstrates the LangChain/LangGraph ReAct agent pattern. The agent autonomously decides which tools to call and in what order, showing its reasoning chain in the chat. Ideal for complex multi-step queries that require the AI to plan its approach.
...
```
https://apps.marketcheck.com/app/chat-langchain/?api_key=YOUR_API_KEY
```
...
```html
<iframe src="https://apps.marketcheck.com/app/chat-langchain/?api_key=YOUR_API_KEY" width="100%" height="800" frameborder="0"></iframe>
```
...
- [AI Agent Explorer (LangChain) App](https://apps.marketcheck.com/app/chat-langchain/)
