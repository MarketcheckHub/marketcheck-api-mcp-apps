/**
 * Multi-Platform Bot — Chat SDK Demo
...
const ACCENT = "#f97316";
const SDK_NAME = "Chat SDK";
const SUGGESTIONS = [
  "Search Toyota Camry under $25K near Chicago",
  "What's this VIN? 1HGCV1F34LA000001",
  "Top 5 selling brands in New York?",
  "Any Honda incentives near 10001?",
  "Price check VIN WBA7E2C51JG123456",
];
...
function init() {
  const { header, content } = createAppShell("Multi-Platform Bot");
