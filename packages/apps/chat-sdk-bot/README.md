# Multi-Platform Bot (Chat SDK) ![Chat Demos](https://img.shields.io/badge/Chat%20Demos-6366f1?style=flat-square)

![Screenshot](../../../static/screenshots/chat-sdk-bot.png)

## Overview

Demonstrates the Chat SDK (chat-sdk.dev) pattern for multi-platform bots. A single codebase that deploys to Slack, Discord, Telegram, and Microsoft Teams. In the browser demo, shows the same conversational UX that would work across messaging platforms.
...
```
https://apps.marketcheck.com/app/chat-sdk-bot/?api_key=YOUR_API_KEY
```
...
```html
<iframe src="https://apps.marketcheck.com/app/chat-sdk-bot/?api_key=YOUR_API_KEY" width="100%" height="800" frameborder="0"></iframe>
```
...
- [Multi-Platform Bot (Chat SDK) App](https://apps.marketcheck.com/app/chat-sdk-bot/)
