# Incentive Deal Finder ![Consumer](https://img.shields.io/badge/Consumer-10b981?style=flat-square)

![Screenshot](../../../static/screenshots/incentive-deal-finder.png)

## Overview

Scans incentives from 10+ major manufacturers simultaneously for a given ZIP code. Aggregates and ranks all available deals — cash back, financing specials, lease offers — so shoppers can find the best incentives regardless of brand loyalty.
...
```
https://apps.marketcheck.com/app/incentive-deal-finder/?api_key=YOUR_API_KEY
```
...
```html
<iframe src="https://apps.marketcheck.com/app/incentive-deal-finder/?api_key=YOUR_API_KEY" width="100%" height="800" frameborder="0"></iframe>
```
...
- [Incentive Deal Finder App](https://apps.marketcheck.com/app/incentive-deal-finder/)
