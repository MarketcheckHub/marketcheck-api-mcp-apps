/**
 * Quick Market Check — Streamlit Demo
...
const ACCENT = "#ec4899";
const SDK_NAME = "Streamlit";
const SUGGESTIONS = [
  "Quick search: Honda CR-V under $30K near 98101",
  "Decode this VIN: 5YJSA1DG9DFP14705",
  "What's the average sale price by state?",
  "Toyota incentives near 94105",
  "Market summary: top makes by sold count",
];
...
function init() {
  const { header, content } = createAppShell("Quick Market Check");
