# Quick Market Check (Streamlit) ![Chat Demos](https://img.shields.io/badge/Chat%20Demos-6366f1?style=flat-square)

![Screenshot](../../../static/screenshots/chat-streamlit.png)
...
```
https://apps.marketcheck.com/app/chat-streamlit/?api_key=YOUR_API_KEY
```
...
```html
<iframe src="https://apps.marketcheck.com/app/chat-streamlit/?api_key=YOUR_API_KEY" width="100%" height="800" frameborder="0"></iframe>
```
...
- [Quick Market Check (Streamlit) App](https://apps.marketcheck.com/app/chat-streamlit/)
