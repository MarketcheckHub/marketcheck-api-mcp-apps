# Market Analyst (Chainlit) ![Chat Demos](https://img.shields.io/badge/Chat%20Demos-6366f1?style=flat-square)

![Screenshot](../../../static/screenshots/chat-chainlit.png)

## Overview

Demonstrates the Chainlit pattern for Python-based chat applications. Features built-in tool execution steps with expandable input/output visualization. Ideal for data science and analytics use cases where tool execution transparency is important.
...
```
https://apps.marketcheck.com/app/chat-chainlit/?api_key=YOUR_API_KEY
```
...
```html
<iframe src="https://apps.marketcheck.com/app/chat-chainlit/?api_key=YOUR_API_KEY" width="100%" height="800" frameborder="0"></iframe>
```
...
- [Market Analyst (Chainlit) App](https://apps.marketcheck.com/app/chat-chainlit/)
