/**
 * Market Analyst — Chainlit Chat Demo
...
const ACCENT = "#06b6d4";
const SDK_NAME = "Chainlit";
const SUGGESTIONS = [
  "Analyze the used car market in California",
  "Decode VIN 1HGCV1F34LA000001 and get its full history",
  "Search for used Hyundai Tucson under $28K near 90210",
  "What are the best-selling body types nationwide?",
  "Find Kia incentives available near ZIP 75201",
];
...
function init() {
  const { header, content } = createAppShell("Market Analyst");
