/**
 * MarketCheck Chat — assistant-ui Demo
...
const ACCENT = "#10b981";
const SDK_NAME = "assistant-ui";
const SUGGESTIONS = [
  "Find me a used Tesla Model 3 under $35K near Los Angeles",
  "Decode VIN 5YJSA1DG9DFP14705 and predict its price",
  "What are the top selling SUVs in Texas?",
  "Check Ford incentives near ZIP 30301",
  "Show me the market trend for electric vehicles",
];
...
function init() {
  const { header, content } = createAppShell("MarketCheck Chat");
