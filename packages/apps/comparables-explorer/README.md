# Comparables Explorer ![Appraiser](https://img.shields.io/badge/Appraiser-3b82f6?style=flat-square)

![Screenshot](../../../static/screenshots/comparables-explorer.png)

## Overview

Flexible comparable search by VIN or make/model/year. Shows active listings (up to 50) and sold listings (up to 25) with price distribution, stats, and optional price prediction. Adjustable search radius for broad or narrow market analysis.
...
|------|------|----------|-------------|
| `vin` | string | No | VIN (optional — or use make/model) |
| `make` | string | No | Vehicle make |
| `model` | string | No | Vehicle model |
| `year` | string | No | Year or range |
| `zip` | string | No | ZIP code |
| `radius` | number | No | Search radius (default 100 mi) |
...
```
https://apps.marketcheck.com/app/comparables-explorer/?api_key=YOUR_API_KEY
```
...
```html
<iframe src="https://apps.marketcheck.com/app/comparables-explorer/?api_key=YOUR_API_KEY" width="100%" height="800" frameborder="0"></iframe>
```
...
- [Comparables Explorer App](https://apps.marketcheck.com/app/comparables-explorer/)
